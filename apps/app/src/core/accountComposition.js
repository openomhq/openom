...
/** @typedef {{ readonly createAuth: (account: AccountSession) => AuthSession, readonly createRemote?: (auth: SessionController) => RemoteStore | null }} AccountCompositionOptions */
