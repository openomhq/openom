...
export const ERROR_CODES = Object.freeze({
  ...
  account_backup_precondition_failed: Object.freeze({ domain: 'sync', title: 'Account backup precondition failed', retriable: false, action: null, args: Object.freeze([]) }),
  ...
  generation_rollback: Object.freeze({ domain: 'vault', title: 'Account backup rolled back', retriable: false, action: null, args: Object.freeze([]) }),
  account_backup_rollback: Object.freeze({ domain: 'vault', title: 'Account backup rollback detected', retriable: false, action: null, args: Object.freeze([]) }),
...
export function fluentKey(code) {
  const m = /** @type {Readonly<Record<string, ErrorCodeMetadata>>} */ (ERROR_CODES)[code];
